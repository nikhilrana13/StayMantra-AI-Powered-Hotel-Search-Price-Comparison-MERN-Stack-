    ...
    >
      <header>
        <table style="width: 100%;">
          <tbody>
            <tr style="height: 0;">
              <td class="logo" style="font-size:40px; font-weight: 800; color: #000000">
               StayMantra
              </td>
            </tr>
          </tbody>
      ...
      <main>
        ...
        >
          <div style="width: 100%; max-width: 489px; margin: 0 auto;">
            <p
              ...
              "
            >
              Thank you for signing up. Use the following OTP
        ...
        >
          Need help? Ask at
          <a
            href="mailto:nikhilrajput060@gmail.com"
            style="color: #499fb6; text-decoration: none;"
            >nikhilrajput060@gmail.com</a
          >
          or visit our
          <a
            href=""
...
export const Welcome_Email_Template = `
  ...
  <body>
      <div class="container">
          ...
          <div class="footer ">
              <p>&copy; ${new Date().getFullYear()} StayMantra. All rights reserved.</p>
          </div>
      </div>
  </body>
  </html>
